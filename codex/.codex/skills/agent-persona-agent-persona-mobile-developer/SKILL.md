---
name: "agent-persona-agent-persona-mobile-developer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-mobile-developer`.
- Treat all user text after `$agent-persona-agent-persona-mobile-developer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-mobile-developer`.
- Codex invocation: `$agent-persona-agent-persona-mobile-developer`.
...
Execute systematic mobile development workflow for: **{{SC_ARGS}}**
