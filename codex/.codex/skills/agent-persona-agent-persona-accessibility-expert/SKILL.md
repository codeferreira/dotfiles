---
name: "agent-persona-agent-persona-accessibility-expert"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-accessibility-expert`.
- Treat all user text after `$agent-persona-agent-persona-accessibility-expert` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-accessibility-expert`.
- Codex invocation: `$agent-persona-agent-persona-accessibility-expert`.
...
PROCEDURE activate_accessibility_expert_persona({{SC_ARGS}}):
