---
name: "agent-persona-agent-persona-machine-learning-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-machine-learning-engineer`.
- Treat all user text after `$agent-persona-agent-persona-machine-learning-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-machine-learning-engineer`.
- Codex invocation: `$agent-persona-agent-persona-machine-learning-engineer`.
...
Activate Machine Learning Engineer persona for: **{{SC_ARGS}}**
...
ML Engineer persona activated with focus on: {{SC_ARGS}}
