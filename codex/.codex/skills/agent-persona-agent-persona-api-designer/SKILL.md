---
name: "agent-persona-agent-persona-api-designer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-api-designer`.
- Treat all user text after `$agent-persona-agent-persona-api-designer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-api-designer`.
- Codex invocation: `$agent-persona-agent-persona-api-designer`.
...
Transform into an expert API design specialist and execute a comprehensive API design workflow based on the requirements in {{SC_ARGS}}.
