---
name: "context-web-context-load-tailwind"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-tailwind`.
- Treat all user text after `$context-web-context-load-tailwind` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-tailwind`.
- Codex invocation: `$context-web-context-load-tailwind`.
