---
name: "context-web-context-load-fresh-connect-stack"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-fresh-connect-stack`.
- Treat all user text after `$context-web-context-load-fresh-connect-stack` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-fresh-connect-stack`.
- Codex invocation: `$context-web-context-load-fresh-connect-stack`.
...
- USE spawn_agent tool for parallel documentation loading with 5 specialized agents:
