...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$github-github-codesearch`.
- Treat all user text after `$github-github-codesearch` as `{{SC_ARGS}}`.
...
- Original command: `github:github-codesearch`.
- Codex invocation: `$github-github-codesearch`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Search query: {{SC_ARGS}}
...
4. Use GitHub CLI to search for code with text matches: `gh api search/code --header "Accept: application/vnd.github.text-match+json" --raw-field q="{{SC_ARGS}}"`
