---
name: "agent-persona-agent-persona-backend-specialist"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-backend-specialist`.
- Treat all user text after `$agent-persona-agent-persona-backend-specialist` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-backend-specialist`.
- Codex invocation: `$agent-persona-agent-persona-backend-specialist`.
