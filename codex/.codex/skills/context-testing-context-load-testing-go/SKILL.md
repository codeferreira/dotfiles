---
name: "context-testing-context-load-testing-go"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-testing-context-load-testing-go`.
- Treat all user text after `$context-testing-context-load-testing-go` as `{{SC_ARGS}}`.
...
- Original command: `context:testing:context-load-testing-go`.
- Codex invocation: `$context-testing-context-load-testing-go`.
