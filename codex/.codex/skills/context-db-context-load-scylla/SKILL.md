---
name: "context-db-context-load-scylla"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-db-context-load-scylla`.
- Treat all user text after `$context-db-context-load-scylla` as `{{SC_ARGS}}`.
...
- Original command: `context:db:context-load-scylla`.
- Codex invocation: `$context-db-context-load-scylla`.
