---
name: "context-rust-context-load-rust-async"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-rust-context-load-rust-async`.
- Treat all user text after `$context-rust-context-load-rust-async` as `{{SC_ARGS}}`.
...
- Original command: `context:rust:context-load-rust-async`.
- Codex invocation: `$context-rust-context-load-rust-async`.
...
- ORGANIZE loaded context by async programming domains:
  ...
  - **spawn_agent Coordination**: Spawning, joining, cancellation, timeouts
...
- spawn_agent spawning, joining, and lifecycle management
