---
name: "agent-persona-agent-persona-code-reviewer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-code-reviewer`.
- Treat all user text after `$agent-persona-agent-persona-code-reviewer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-code-reviewer`.
- Codex invocation: `$agent-persona-agent-persona-code-reviewer`.
...
IF {{SC_ARGS}} contains specific files:
