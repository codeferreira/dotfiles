---
name: "agent-persona-agent-persona-database-architect"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-database-architect`.
- Treat all user text after `$agent-persona-agent-persona-database-architect` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-database-architect`.
- Codex invocation: `$agent-persona-agent-persona-database-architect`.
