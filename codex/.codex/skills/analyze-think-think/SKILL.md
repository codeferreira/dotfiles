...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$analyze-think-think`.
- Treat all user text after `$analyze-think-think` as `{{SC_ARGS}}`.
...
- Original command: `analyze:think:think`.
- Codex invocation: `$analyze-think-think`.
