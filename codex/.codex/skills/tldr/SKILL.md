---
name: "tldr"
description: "Codex port of tldr"
metadata:
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$tldr`.
- Treat all user text after `$tldr` as `{{SC_ARGS}}`.
...
- Original command: `tldr`.
- Codex invocation: `$tldr`.
