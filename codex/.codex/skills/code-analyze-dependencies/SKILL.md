---
name: "code-analyze-dependencies"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$code-analyze-dependencies`.
- Treat all user text after `$code-analyze-dependencies` as `{{SC_ARGS}}`.
...
- Original command: `code:analyze:dependencies`.
- Codex invocation: `$code-analyze-dependencies`.
...
**IMMEDIATELY DEPLOY 10 PARALLEL SUB-AGENTS** for lightning-fast dependency analysis of: {{SC_ARGS}}
...
- Determine analysis scope: {{SC_ARGS}}
