---
name: "agent-persona-agent-persona-performance-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-performance-engineer`.
- Treat all user text after `$agent-persona-agent-persona-performance-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-performance-engineer`.
- Codex invocation: `$agent-persona-agent-persona-performance-engineer`.
...
Think deeply about the performance optimization challenge: **{{SC_ARGS}}**
