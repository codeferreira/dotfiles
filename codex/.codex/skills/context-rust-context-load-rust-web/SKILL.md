---
name: "context-rust-context-load-rust-web"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-rust-context-load-rust-web`.
- Treat all user text after `$context-rust-context-load-rust-web` as `{{SC_ARGS}}`.
...
- Original command: `context:rust:context-load-rust-web`.
- Codex invocation: `$context-rust-context-load-rust-web`.
