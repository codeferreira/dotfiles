---
name: "agent-persona-agent-persona-test-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-test-engineer`.
- Treat all user text after `$agent-persona-agent-persona-test-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-test-engineer`.
- Codex invocation: `$agent-persona-agent-persona-test-engineer`.
...
- Create comprehensive testing strategy based on {{SC_ARGS}}
