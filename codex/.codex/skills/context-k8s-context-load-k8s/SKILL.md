---
name: "context-k8s-context-load-k8s"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-k8s-context-load-k8s`.
- Treat all user text after `$context-k8s-context-load-k8s` as `{{SC_ARGS}}`.
...
- Original command: `context:k8s:context-load-k8s`.
- Codex invocation: `$context-k8s-context-load-k8s`.
