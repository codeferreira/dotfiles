...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$workflow-manage-sync`.
- Treat all user text after `$workflow-manage-sync` as `{{SC_ARGS}}`.
...
- Original command: `workflow:manage:sync`.
- Codex invocation: `$workflow-manage-sync`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target editors: {{SC_ARGS}}
