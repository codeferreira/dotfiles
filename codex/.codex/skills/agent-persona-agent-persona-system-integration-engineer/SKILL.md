---
name: "agent-persona-agent-persona-system-integration-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-system-integration-engineer`.
- Treat all user text after `$agent-persona-agent-persona-system-integration-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-system-integration-engineer`.
- Codex invocation: `$agent-persona-agent-persona-system-integration-engineer`.
