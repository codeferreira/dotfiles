---
name: "agent-persona-agent-persona-security-auditor"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-security-auditor`.
- Treat all user text after `$agent-persona-agent-persona-security-auditor` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-security-auditor`.
- Codex invocation: `$agent-persona-agent-persona-security-auditor`.
