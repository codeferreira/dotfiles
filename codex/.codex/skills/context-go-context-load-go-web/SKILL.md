---
name: "context-go-context-load-go-web"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-go-context-load-go-web`.
- Treat all user text after `$context-go-context-load-go-web` as `{{SC_ARGS}}`.
...
- Original command: `context:go:context-load-go-web`.
- Codex invocation: `$context-go-context-load-go-web`.
