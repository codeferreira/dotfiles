...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$tool-five`.
- Treat all user text after `$tool-five` as `{{SC_ARGS}}`.
...
- Original command: `tool:five`.
- Codex invocation: `$tool-five`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Problem description: {{SC_ARGS}}
...
- Parse the problem statement from {{SC_ARGS}}
