---
name: "agent-persona-agent-persona-ux-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-ux-engineer`.
- Treat all user text after `$agent-persona-agent-persona-ux-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-ux-engineer`.
- Codex invocation: `$agent-persona-agent-persona-ux-engineer`.
