---
name: "context-deno-context-load-deno-fresh"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-deno-context-load-deno-fresh`.
- Treat all user text after `$context-deno-context-load-deno-fresh` as `{{SC_ARGS}}`.
...
- Original command: `context:deno:context-load-deno-fresh`.
- Codex invocation: `$context-deno-context-load-deno-fresh`.
