---
name: "context-k8s-context-load-talos"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-k8s-context-load-talos`.
- Treat all user text after `$context-k8s-context-load-talos` as `{{SC_ARGS}}`.
...
- Original command: `context:k8s:context-load-talos`.
- Codex invocation: `$context-k8s-context-load-talos`.
