---
name: "context-k8s-context-load-flux"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-k8s-context-load-flux`.
- Treat all user text after `$context-k8s-context-load-flux` as `{{SC_ARGS}}`.
...
- Original command: `context:k8s:context-load-flux`.
- Codex invocation: `$context-k8s-context-load-flux`.
