...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$docs-generate-api-docs`.
- Treat all user text after `$docs-generate-api-docs` as `{{SC_ARGS}}`.
...
- Original command: `docs:generate:api-docs`.
- Codex invocation: `$docs-generate-api-docs`.
