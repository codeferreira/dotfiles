...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$workflow-view-tldr`.
- Treat all user text after `$workflow-view-tldr` as `{{SC_ARGS}}`.
...
- Original command: `workflow:view:tldr`.
- Codex invocation: `$workflow-view-tldr`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target content: {{SC_ARGS}}
