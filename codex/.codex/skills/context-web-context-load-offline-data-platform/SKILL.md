---
name: "context-web-context-load-offline-data-platform"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-offline-data-platform`.
- Treat all user text after `$context-web-context-load-offline-data-platform` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-offline-data-platform`.
- Codex invocation: `$context-web-context-load-offline-data-platform`.
...
- EXECUTE parallel WebFetch documentation loading with spawn_agent tool:
