...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$code-refactor-refactor`.
- Treat all user text after `$code-refactor-refactor` as `{{SC_ARGS}}`.
...
- Original command: `code:refactor:refactor`.
- Codex invocation: `$code-refactor-refactor`.
...
IF {{SC_ARGS}} is directory AND contains >100 files:
...
- CREATE inter-agent communication files: `/tmp/refactor-agents-$SESSION_ID/`
  ELSE IF {{SC_ARGS}} is single large file (>1000 lines):
...
spawn_agent 1: **Architectural Smell Detection Agent**
...
spawn_agent 2: **Code Duplication Hunter Agent**
...
spawn_agent 3: **Complexity Analyzer Agent**
...
spawn_agent 4: **Type Safety Auditor Agent**
...
spawn_agent 5: **Performance Bottleneck Agent**
...
spawn_agent 6: **Design Pattern Violation Agent**
...
spawn_agent 7: **Test Quality Inspector Agent**
...
spawn_agent 8: **Dependency Analysis Agent**
...
spawn_agent 9: **Security Smell Detection Agent**
...
spawn_agent 10: **Documentation Debt Agent**
...
spawn_agent 1: **Method Extraction Agent**
...
spawn_agent 2: **Class Decomposition Agent**
...
spawn_agent 3: **Duplicate Code Elimination Agent**
...
spawn_agent 4: **Type Safety Enhancement Agent**
...
spawn_agent 5: **Performance Optimization Agent**
...
spawn_agent 6: **Pattern Implementation Agent**
...
spawn_agent 7: **Test Enhancement Agent**
...
spawn_agent 8: **Documentation Update Agent**
