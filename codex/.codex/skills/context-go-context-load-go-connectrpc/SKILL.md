---
name: "context-go-context-load-go-connectrpc"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-go-context-load-go-connectrpc`.
- Treat all user text after `$context-go-context-load-go-connectrpc` as `{{SC_ARGS}}`.
...
- Original command: `context:go:context-load-go-connectrpc`.
- Codex invocation: `$context-go-context-load-go-connectrpc`.
