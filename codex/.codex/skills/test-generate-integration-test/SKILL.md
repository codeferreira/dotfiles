---
name: "test-generate-integration-test"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$test-generate-integration-test`.
- Treat all user text after `$test-generate-integration-test` as `{{SC_ARGS}}`.
...
- Original command: `test:generate:integration-test`.
- Codex invocation: `$test-generate-integration-test`.
