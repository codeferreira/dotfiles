...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$analyze-data-data-viz`.
- Treat all user text after `$analyze-data-data-viz` as `{{SC_ARGS}}`.
...
- Original command: `analyze:data:data-viz`.
- Codex invocation: `$analyze-data-data-viz`.
...
Generate interactive data visualizations and dashboards for: **{{SC_ARGS}}**
