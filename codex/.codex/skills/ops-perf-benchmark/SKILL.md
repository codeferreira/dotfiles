...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$ops-perf-benchmark`.
- Treat all user text after `$ops-perf-benchmark` as `{{SC_ARGS}}`.
...
- Original command: `ops:perf:benchmark`.
- Codex invocation: `$ops-perf-benchmark`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Benchmark target: {{SC_ARGS}}
