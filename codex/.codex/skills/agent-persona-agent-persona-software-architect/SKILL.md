---
name: "agent-persona-agent-persona-software-architect"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-software-architect`.
- Treat all user text after `$agent-persona-agent-persona-software-architect` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-software-architect`.
- Codex invocation: `$agent-persona-agent-persona-software-architect`.
