---
name: "agent-agent-browser-automation"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-agent-browser-automation`.
- Treat all user text after `$agent-agent-browser-automation` as `{{SC_ARGS}}`.
...
- Original command: `agent:agent-browser-automation`.
- Codex invocation: `$agent-agent-browser-automation`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target URL or action: {{SC_ARGS}}
...
- PARSE {{SC_ARGS}} to determine testing scenario
