---
name: "ops-project-project-status-deno"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$ops-project-project-status-deno`.
- Treat all user text after `$ops-project-project-status-deno` as `{{SC_ARGS}}`.
...
- Original command: `ops:project:project-status-deno`.
- Codex invocation: `$ops-project-project-status-deno`.
...
6. **spawn_agent Management Agent**: deno.json configuration, available tasks, script analysis, project automation
...
**Agent 6: spawn_agent Management Analysis**
...
4. **spawn_agent Management**: deno.json configuration and tasks
