---
name: "agent-persona-agent-persona-debugger"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-debugger`.
- Treat all user text after `$agent-persona-agent-persona-debugger` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-debugger`.
- Codex invocation: `$agent-persona-agent-persona-debugger`.
