...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$workflow-manage-clean`.
- Treat all user text after `$workflow-manage-clean` as `{{SC_ARGS}}`.
...
- Original command: `workflow:manage:clean`.
- Codex invocation: `$workflow-manage-clean`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target for cleanup: {{SC_ARGS}}
