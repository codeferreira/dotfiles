---
name: "scaffold-scaffold-docusaurus-setup"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$scaffold-scaffold-docusaurus-setup`.
- Treat all user text after `$scaffold-scaffold-docusaurus-setup` as `{{SC_ARGS}}`.
...
- Original command: `scaffold:scaffold-docusaurus-setup`.
- Codex invocation: `$scaffold-scaffold-docusaurus-setup`.
