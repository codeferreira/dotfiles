---
name: "agent-persona-agent-persona-technical-writer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-technical-writer`.
- Treat all user text after `$agent-persona-agent-persona-technical-writer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-technical-writer`.
- Codex invocation: `$agent-persona-agent-persona-technical-writer`.
...
- Create comprehensive documentation strategy based on {{SC_ARGS}}
