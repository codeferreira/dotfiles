---
name: "agent-persona-agent-persona-test-automation-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-test-automation-engineer`.
- Treat all user text after `$agent-persona-agent-persona-test-automation-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-test-automation-engineer`.
- Codex invocation: `$agent-persona-agent-persona-test-automation-engineer`.
