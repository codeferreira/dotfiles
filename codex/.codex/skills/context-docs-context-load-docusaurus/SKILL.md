---
name: "context-docs-context-load-docusaurus"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-docs-context-load-docusaurus`.
- Treat all user text after `$context-docs-context-load-docusaurus` as `{{SC_ARGS}}`.
...
- Original command: `context:docs:context-load-docusaurus`.
- Codex invocation: `$context-docs-context-load-docusaurus`.
