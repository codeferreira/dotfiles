...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$workflow-manage-release`.
- Treat all user text after `$workflow-manage-release` as `{{SC_ARGS}}`.
...
- Original command: `workflow:manage:release`.
- Codex invocation: `$workflow-manage-release`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target release: {{SC_ARGS}}
