...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$analyze-data-visualize`.
- Treat all user text after `$analyze-data-visualize` as `{{SC_ARGS}}`.
...
- Original command: `analyze:data:visualize`.
- Codex invocation: `$analyze-data-visualize`.
