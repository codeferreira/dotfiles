---
name: "context-k8s-context-load-cilium"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-k8s-context-load-cilium`.
- Treat all user text after `$context-k8s-context-load-cilium` as `{{SC_ARGS}}`.
...
- Original command: `context:k8s:context-load-cilium`.
- Codex invocation: `$context-k8s-context-load-cilium`.
