---
name: "scaffold-go-scaffold-go-connect"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$scaffold-go-scaffold-go-connect`.
- Treat all user text after `$scaffold-go-scaffold-go-connect` as `{{SC_ARGS}}`.
...
- Original command: `scaffold:go:scaffold-go-connect`.
- Codex invocation: `$scaffold-go-scaffold-go-connect`.
...
option go_package = "github.com/example/{{SC_ARGS}}/gen/greet/v1;greetv1";
...
go mod init github.com/example/{{SC_ARGS}}
...
import (
	...
	greetv1 "github.com/example/{{SC_ARGS}}/gen/greet/v1"
)
...
import (
	...
	greetv1connect "github.com/example/{{SC_ARGS}}/gen/greet/v1/greetv1connect"
	"github.com/example/{{SC_ARGS}}/internal/service"
)
