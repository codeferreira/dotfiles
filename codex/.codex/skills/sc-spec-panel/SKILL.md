...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$sc-spec-panel`.
- Treat all user text after `$sc-spec-panel` as `{{SC_ARGS}}`.
...
- Original command: `spec-panel`.
- Codex invocation: `$sc-spec-panel`.
