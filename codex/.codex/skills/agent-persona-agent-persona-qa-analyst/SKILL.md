---
name: "agent-persona-agent-persona-qa-analyst"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-qa-analyst`.
- Treat all user text after `$agent-persona-agent-persona-qa-analyst` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-qa-analyst`.
- Codex invocation: `$agent-persona-agent-persona-qa-analyst`.
...
Think deeply about the quality assurance challenge: **{{SC_ARGS}}**
