---
name: "workflow-create-prototype"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$workflow-create-prototype`.
- Treat all user text after `$workflow-create-prototype` as `{{SC_ARGS}}`.
...
- Original command: `workflow:create:prototype`.
- Codex invocation: `$workflow-create-prototype`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Prototype target: {{SC_ARGS}}
...
- ANALYZE prototype requirements from {{SC_ARGS}}
