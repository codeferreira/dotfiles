---
name: "context-web-context-load-github-actions"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-github-actions`.
- Treat all user text after `$context-web-context-load-github-actions` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-github-actions`.
- Codex invocation: `$context-web-context-load-github-actions`.
