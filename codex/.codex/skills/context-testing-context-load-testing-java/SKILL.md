---
name: "context-testing-context-load-testing-java"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-testing-context-load-testing-java`.
- Treat all user text after `$context-testing-context-load-testing-java` as `{{SC_ARGS}}`.
...
- Original command: `context:testing:context-load-testing-java`.
- Codex invocation: `$context-testing-context-load-testing-java`.
...
- USE spawn_agent tool to delegate parallel documentation loading:
