---
name: "security-audit-secrets-audit"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$security-audit-secrets-audit`.
- Treat all user text after `$security-audit-secrets-audit` as `{{SC_ARGS}}`.
...
- Original command: `security:audit:secrets-audit`.
- Codex invocation: `$security-audit-secrets-audit`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Scan scope: {{SC_ARGS}} (default: comprehensive scan)
