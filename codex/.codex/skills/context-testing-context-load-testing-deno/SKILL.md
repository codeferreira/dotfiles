---
name: "context-testing-context-load-testing-deno"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-testing-context-load-testing-deno`.
- Treat all user text after `$context-testing-context-load-testing-deno` as `{{SC_ARGS}}`.
...
- Original command: `context:testing:context-load-testing-deno`.
- Codex invocation: `$context-testing-context-load-testing-deno`.
