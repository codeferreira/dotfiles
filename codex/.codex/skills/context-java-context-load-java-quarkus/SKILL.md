---
name: "context-java-context-load-java-quarkus"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-java-context-load-java-quarkus`.
- Treat all user text after `$context-java-context-load-java-quarkus` as `{{SC_ARGS}}`.
...
- Original command: `context:java:context-load-java-quarkus`.
- Codex invocation: `$context-java-context-load-java-quarkus`.
