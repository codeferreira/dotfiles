---
name: "context-observability-context-load-logging"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-observability-context-load-logging`.
- Treat all user text after `$context-observability-context-load-logging` as `{{SC_ARGS}}`.
...
- Original command: `context:observability:context-load-logging`.
- Codex invocation: `$context-observability-context-load-logging`.
