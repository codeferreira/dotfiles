...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$docs-generate-changelog`.
- Treat all user text after `$docs-generate-changelog` as `{{SC_ARGS}}`.
...
- Original command: `docs:generate:changelog`.
- Codex invocation: `$docs-generate-changelog`.
- Preserve the behavioral intent of the source command, but use Codex-native tools and collaboration primitives.
</codex_skill_adapter>

## Context

- Target range: {{SC_ARGS}}
