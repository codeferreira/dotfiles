---
name: "context-rust-context-load-rust-db"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-rust-context-load-rust-db`.
- Treat all user text after `$context-rust-context-load-rust-db` as `{{SC_ARGS}}`.
...
- Original command: `context:rust:context-load-rust-db`.
- Codex invocation: `$context-rust-context-load-rust-db`.
...
- USE spawn_agent tool to delegate specialized context loading:
