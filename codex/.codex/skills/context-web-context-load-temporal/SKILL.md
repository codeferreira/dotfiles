---
name: "context-web-context-load-temporal"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-temporal`.
- Treat all user text after `$context-web-context-load-temporal` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-temporal`.
- Codex invocation: `$context-web-context-load-temporal`.
...
- USE spawn_agent tool to delegate parallel documentation loading with 5 specialized agents:
...
3. **Worker Architecture**
   - spawn_agent queue configuration
