---
name: "agent-persona-agent-persona-requirements-analyst"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-requirements-analyst`.
- Treat all user text after `$agent-persona-agent-persona-requirements-analyst` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-requirements-analyst`.
- Codex invocation: `$agent-persona-agent-persona-requirements-analyst`.
