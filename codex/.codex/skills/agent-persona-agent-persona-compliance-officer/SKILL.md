---
name: "agent-persona-agent-persona-compliance-officer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-compliance-officer`.
- Treat all user text after `$agent-persona-agent-persona-compliance-officer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-compliance-officer`.
- Codex invocation: `$agent-persona-agent-persona-compliance-officer`.
...
Activate Compliance Officer persona for: **{{SC_ARGS}}**
...
Compliance Officer persona activated with focus on: {{SC_ARGS}}
