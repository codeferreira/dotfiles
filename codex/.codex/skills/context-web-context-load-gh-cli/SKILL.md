---
name: "context-web-context-load-gh-cli"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-web-context-load-gh-cli`.
- Treat all user text after `$context-web-context-load-gh-cli` as `{{SC_ARGS}}`.
...
- Original command: `context:web:context-load-gh-cli`.
- Codex invocation: `$context-web-context-load-gh-cli`.
