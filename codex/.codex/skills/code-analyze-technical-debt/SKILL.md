---
name: "code-analyze-technical-debt"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$code-analyze-technical-debt`.
- Treat all user text after `$code-analyze-technical-debt` as `{{SC_ARGS}}`.
...
- Original command: `code:analyze:technical-debt`.
- Codex invocation: `$code-analyze-technical-debt`.
...
**IMMEDIATELY DEPLOY 8 PARALLEL TECHNICAL DEBT ANALYSIS AGENTS** for ultra-fast comprehensive debt assessment: **{{SC_ARGS}}**
