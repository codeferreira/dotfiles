...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$sc-recommend`.
- Treat all user text after `$sc-recommend` as `{{SC_ARGS}}`.
...
- Original command: `sc:recommend`.
- Codex invocation: `$sc-recommend`.
