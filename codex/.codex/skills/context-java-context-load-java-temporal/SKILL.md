---
name: "context-java-context-load-java-temporal"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-java-context-load-java-temporal`.
- Treat all user text after `$context-java-context-load-java-temporal` as `{{SC_ARGS}}`.
...
- Original command: `context:java:context-load-java-temporal`.
- Codex invocation: `$context-java-context-load-java-temporal`.
...
- Signal and query handling mechanisms
- spawn_agent queue configuration and worker management
