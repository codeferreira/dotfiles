...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$sc-index`.
- Treat all user text after `$sc-index` as `{{SC_ARGS}}`.
...
- **spawn_agent**: Advanced delegation for large-scale documentation requiring systematic coordination
