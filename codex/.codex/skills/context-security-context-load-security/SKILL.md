---
name: "context-security-context-load-security"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-security-context-load-security`.
- Treat all user text after `$context-security-context-load-security` as `{{SC_ARGS}}`.
...
- Original command: `context:security:context-load-security`.
- Codex invocation: `$context-security-context-load-security`.
