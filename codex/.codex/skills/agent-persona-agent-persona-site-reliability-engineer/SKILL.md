---
name: "agent-persona-agent-persona-site-reliability-engineer"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$agent-persona-agent-persona-site-reliability-engineer`.
- Treat all user text after `$agent-persona-agent-persona-site-reliability-engineer` as `{{SC_ARGS}}`.
...
- Original command: `agent:persona:agent-persona-site-reliability-engineer`.
- Codex invocation: `$agent-persona-agent-persona-site-reliability-engineer`.
...
```bash
/agent-persona-site-reliability-engineer [{{SC_ARGS}}]
```
...
IF {{SC_ARGS}} contains "monitoring":
...
IF {{SC_ARGS}} contains "SLO" OR "reliability":
...
IF {{SC_ARGS}} contains "chaos" OR "testing":
...
STEP 3: Execute SRE Engineering spawn_agents
