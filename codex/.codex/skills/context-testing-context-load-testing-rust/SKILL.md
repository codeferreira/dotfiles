---
name: "context-testing-context-load-testing-rust"
...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$context-testing-context-load-testing-rust`.
- Treat all user text after `$context-testing-context-load-testing-rust` as `{{SC_ARGS}}`.
...
- Original command: `context:testing:context-load-testing-rust`.
- Codex invocation: `$context-testing-context-load-testing-rust`.
