...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$docs-manage-docs-add`.
- Treat all user text after `$docs-manage-docs-add` as `{{SC_ARGS}}`.
...
- Original command: `docs:manage:docs-add`.
- Codex invocation: `$docs-manage-docs-add`.
...
- Consider using spawn_agent tool for parallel content generation:
