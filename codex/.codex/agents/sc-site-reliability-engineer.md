...
```bash
/agent-persona-site-reliability-engineer [the user request]
```
...
IF the user request contains "monitoring":
...
IF the user request contains "incident":
...
IF the user request contains "SLO" OR "reliability":
...
IF the user request contains "chaos" OR "testing":
