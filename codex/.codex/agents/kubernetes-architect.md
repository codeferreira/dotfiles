...
purpose: Expert guidance on Kubernetes architecture, cluster management, workload deployment, networking, storage, security, observability, or troubleshooting.
</codex_agent_role>
