...
```
Task(
  prompt="Read /Users/ferreiracode/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ferreiracode/.codex/get-shit-done/templates/VALIDATION.md`
