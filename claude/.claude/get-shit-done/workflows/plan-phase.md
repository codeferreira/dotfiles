...
@/Users/ferreiracode/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```
Task(
  prompt="First, read /Users/ferreiracode/.claude/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
**If found:**
1. Read validation template from `/Users/ferreiracode/.claude/get-shit-done/templates/VALIDATION.md`
...
```
Task(
  prompt="First, read /Users/ferreiracode/.claude/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
Task(
  prompt="
    ...
    <execution_context>
    @/Users/ferreiracode/.claude/get-shit-done/workflows/execute-phase.md
    @/Users/ferreiracode/.claude/get-shit-done/references/checkpoints.md
    @/Users/ferreiracode/.claude/get-shit-done/references/tdd.md
    @/Users/ferreiracode/.claude/get-shit-done/references/model-profile-resolution.md
    </execution_context>
