...
```
Task(
  prompt="Read /Users/ferreiracode/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ferreiracode/.claude/get-shit-done/templates/VALIDATION.md`
